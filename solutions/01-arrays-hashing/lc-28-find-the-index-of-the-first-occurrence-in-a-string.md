...
#### Java 程式碼連結
- [ID28FindTheIndexOfTheFirstOccurrenceInAString.java](../../archive/src/main/java/io/github/monty/leetcode/string/ID28FindTheIndexOfTheFirstOccurrenceInAString.java)
