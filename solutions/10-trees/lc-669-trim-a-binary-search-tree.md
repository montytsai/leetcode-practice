...
相信遞迴會「回傳正確的東西」 (Trust the Return Value)
...
#### Java 程式碼連結
- 題目實作：[ID669TrimABinarySearchTree.java](../../archive/src/main/java/io/github/monty/leetcode/binarytree/ID669TrimABinarySearchTree.java)
- 單元測試：[ID669TrimABinarySearchTreeTest.java](../../archive/src/test/java/io/github/monty/leetcode/binarytree/ID669TrimABinarySearchTreeTest.java)
