...
#### Java 程式碼連結
- 題目實作：[ID701InsertIntoABinarySearchTree.java](../../archive/src/main/java/io/github/monty/leetcode/binarytree/ID701InsertIntoABinarySearchTree.java)
- 單元測試：[ID701InsertIntoABinarySearchTreeTest.java](../../archive/src/test/java/io/github/monty/leetcode/binarytree/ID701InsertIntoABinarySearchTreeTest.java)
