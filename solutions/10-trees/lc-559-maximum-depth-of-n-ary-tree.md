...
#### Java 程式碼連結
- 題目實作：[ID559MaximumDepthOfNAryTree.java](../../archive/src/main/java/io/github/monty/leetcode/binarytree/ID559MaximumDepthOfNAryTree.java)
- 單元測試：[ID559MaximumDepthOfNAryTreeTest.java](../../archive/src/test/java/io/github/monty/leetcode/binarytree/ID559MaximumDepthOfNAryTreeTest.java)
