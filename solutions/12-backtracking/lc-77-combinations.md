...
[LeetCode 題目連結](https://leetcode.com/problems/combinations/)

---

## 2025 初刷版（Day41，2025-05-28）

*原文見 [archive/doc/daily/day41-2025-05-28.md](../../archive/doc/daily/day41-2025-05-28.md)，已停更，內容按當時所寫原樣搬入*
...
#### Java 程式碼連結
- 題目實作：[ID77Combinations.java](../../archive/src/main/java/io/github/monty/leetcode/backtracking/ID77Combinations.java)
- 單元測試：[ID77CombinationsTest.java](../../archive/src/test/java/io/github/monty/leetcode/backtracking/ID77CombinationsTest.java)
